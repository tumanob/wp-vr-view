...
var ButtonDialog = {
  ...
  //  var video   = jQuery('#button-dialog input#video').val();
		...
		var pimage  = jQuery('#button-dialog input#pimage').val();
    ...
    //var hascontrols  = jQuery('#button-dialog input#hascontrols').val();
...
<body>
	<div id="button-dialog">
		<form action="/" method="get" accept-charset="utf-8">
			<div>
				<label for="image">PhotoSphere image URL <span style="color:red;">* </span></label>
				<input type="text" name="image" value="" id="image" />
        <!--<a href="#" class="media_add_link"> add image from library</a>-->
			</div>
			<div class="odd">
				<label for="pimage">Preview image URL</label>
				<input type="text" name="pimage" value="" id="pimage" />
			</div>
      <div>
      ...
      <div>
        ...
        <br/>
        <br/>
        <b>Image url</b> should be to jpg or png image files. You can take it from Media library or from any other URL.
        <br/>
        <br/>
